...
Load a trained checkpoint and generate text.
    ...
    python generate.py                          # loads checkpoints/jamba.pt
    python generate.py --ckpt checkpoints/mamba.pt
...
import torch
from model import JambaLM, CharTokenizer
...
def load(ckpt_path):
    ...
    model = JambaLM(
        ...
        attn_every=cfg["attn_every"], moe_every=cfg["moe_every"],
...
def main():
    ...
    ap.add_argument("--ckpt", default=os.path.join(HERE, "checkpoints", "jamba.pt"))
